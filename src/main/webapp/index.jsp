        ...
        <div class="container-xl">
          <div class="row g-2 justify-content-end">
            <div class="col-md-2">
              ...
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addBooks">
            ...
            <div class="col-sm-4 col-lg-5">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-auto">
                      <img src="dist\img\books\book1.jfif" alt="Book Cover" height="100px" width="90px">
                    </div>
                    <div class="col-auto" style="position: relative;">
                      <div class="font-weight-medium"><a href="">
                          <h2>Book Title</h2>
                        </a></div>
                      ...
                      <a href="#" class="btn btn-secondary" style="position: absolute; top: 10px; right: -130px;">
                      ...
                      <a href="#" class="btn btn-secondary" style="position: absolute; top: 10px; right: -70px;">
                        <!-- Download SVG icon from http://tabler-icons.io/i/mail -->
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0">
              <ul class="list-inline list-inline-dots mb-0">
                <li class="list-inline-item">
                  Copyright &copy; 2023
                  <a href="." class="link-secondary">Public Library Management System</a>. All rights
                  reserved.
                </li>
              </ul>
            </div>
        ...
        <form action="#">
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="qty" placeholder="Add Quantity: ">
            </div>
          </div>
